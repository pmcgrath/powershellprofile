...
# Dot source all script files in the d:\poshprofile folder in alphabetical order but sourcing common-functions first
push-location;
@(get-childitem d:\poshprofile\common-functions.ps1) + (get-childitem d:\poshprofile\*.ps1 -exclude common-functions.ps1 | sort name) | sort name | % { "Sourcing $($_.FullName)"; . $_.FullName; }
pop-location;